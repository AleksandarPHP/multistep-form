...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Produkte Position</li>
</ol>
<h1>Produkte Position</h1>
<hr>
<div class="row">
    <div class="col-md-12">
        <form method="post" action="@if(!$editing) {{ url('cms/product-position') }} @else {{ url('cms/product-position/'.$item->id) }} @endif" enctype="multipart/form-data">
            @csrf

...
class AccessoryController extends Controller
{
    ...
    {
        return view('cms.accessories.list');
    }
    ...
    {       
        ...
        foreach($rows as $row) {
            $data[] = [
                ...
                '3' => '<a href="'.url('cms/accessory-items/'.$row->id).'" class="action-edit"><i class="fa-solid fa-plus"></i></a>',
    ...
    public function create()
    {
        ...
        return view('cms.accessories.form', ['item' => new Accessory(), 'editing' => false, 'products' => $products]);
    }
    ...
    {
        $products = Product::where('is_active', 1 )->get();
        return view('cms.accessories.form', ['item' => Accessory::findOrFail($id), 'editing' => true, 'products' => $products]);
    }
